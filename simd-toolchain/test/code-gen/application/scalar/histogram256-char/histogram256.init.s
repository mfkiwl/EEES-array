###BEGIN: histogram256-char app 4 stage CP only bypass
###TOOL: ${S_CG}
...
###END:
###BEGIN: histogram256-char app 4 stage CP only no bypass
###TOOL: ${S_CG}
...
###MDUMP: histogram256.baseline.scalar.dump
###END:
###BEGIN: histogram256-char app 5 stage CP only bypass
###TOOL: ${S_CG}
...
###MDUMP: histogram256.baseline.scalar.dump
###END:
###BEGIN: histogram256-char app 5 stage CP only no bypass
###TOOL: ${S_CG}
...
###BEGIN: histogram256-char app 4 stage RTL
###TOOL: ${S_CC}
###ARGS: ${FILEDIR}/histogram256.sir   -o histogram256-char-4 --arch-cfg ${SOLVER_ROOT}/arch/baseline-32b-4stage.json
###RTL: histogram256-char-4.zip ${SOLVER_ROOT}/arch/baseline-32b-4stage.json ${SOLVER_ROOT}/rtl
###MDUMP: cp.dmem.dump:histogram256.baseline.scalar.dump.ref
###END:

###BEGIN: histogram256-char app 4 stage bypass RTL
###TOOL: ${S_CC}
###ARGS: ${FILEDIR}/histogram256.sir   -o histogram256-char-4-b --arch-cfg ${SOLVER_ROOT}/arch/baseline-32b-4stage-bypass.json
###RTL: histogram256-char-4-b.zip ${SOLVER_ROOT}/arch/baseline-32b-4stage-bypass.json ${SOLVER_ROOT}/rtl
###MDUMP: cp.dmem.dump:histogram256.baseline.scalar.dump.ref
###END:
