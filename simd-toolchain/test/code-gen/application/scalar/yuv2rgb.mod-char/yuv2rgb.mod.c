...
unsigned char yuv[24] = {0xc7, 0xd6, 0xf7, 0x70, 0xae, 0xe8, 0xab, 0x36,
                        0x24, 0x60, 0x7a, 0x28, 0x8b, 0xdb, 0x8,  0xbe,
                        0xfc, 0xa,  0x59, 0x32, 0x2f, 0x50, 0x21, 0x71};
unsigned char rgb[24];

void yuv2rgb_mod(unsigned char * restrict out,
        unsigned char * restrict in, int n) __attribute__((noinline));
...
void
yuv2rgb_mod(unsigned char * restrict out, unsigned char * restrict in, int n) {
    unsigned char *yi, *cbi, *cri, *ro, *go, *bo;
    int i, y, cb, cr, r, g, b;
