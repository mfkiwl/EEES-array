###BEGIN: yuv2rgb.mod app 4 stage CP only bypass
###TOOL: ${S_CG}
###ARGS: ${FILEDIR}/yuv2rgb.mod.sir -o yuv2rgb.mod-4-b.s
###TOOL: ${S_AS}
###ARGS: yuv2rgb.mod-4-b.s -o yuv2rgb.mod-4-b
###TOOL: ${S_SIM}
###ARGS: -imem 0:uni:yuv2rgb.mod-4-b -dmem 0:cp:yuv2rgb.mod-4-b.cp.dmem_init -dump-dmem -dump-dmem-prefix yuv2rgb.mod-4-b -max-cycle 1500
###MDUMP: yuv2rgb.mod-4-b.baseline.scalar.dump:yuv2rgb.mod.baseline.scalar.dump.ref
###END:
###BEGIN: yuv2rgb.mod app 4 stage CP only no bypass
###TOOL: ${S_CG}
...
###END:
###BEGIN: yuv2rgb.mod app 5 stage CP only bypass
###TOOL: ${S_CG}
...
###MDUMP: yuv2rgb.mod.baseline.scalar.dump
###END:
###BEGIN: yuv2rgb.mod app 5 stage CP only no bypass
###TOOL: ${S_CG}
...
###BEGIN: yuv2rgb.mod 4 stage CP only RTL
###TOOL: ${S_CC}
###ARGS: ${FILEDIR}/yuv2rgb.mod.sir -o yuv2rgb.mod-4 --arch-cfg ${SOLVER_ROOT}/arch/baseline-32b-4stage.json
###RTL: yuv2rgb.mod-4.zip ${SOLVER_ROOT}/arch/baseline-32b-4stage.json ${SOLVER_ROOT}/rtl
###MDUMP: cp.dmem.dump:yuv2rgb.mod.baseline.scalar.dump.ref
###END:

###BEGIN: yuv2rgb.mod 4 stage CP only bypass RTL
###TOOL: ${S_CC}
###ARGS: ${FILEDIR}/yuv2rgb.mod.sir -o yuv2rgb.mod-4stage-cp-bypass --arch-cfg ${SOLVER_ROOT}/arch/baseline-32b-4stage-bypass.json
###RTL: yuv2rgb.mod-4stage-cp-bypass.zip ${SOLVER_ROOT}/arch/baseline-32b-4stage-bypass.json ${SOLVER_ROOT}/rtl
###MDUMP: cp.dmem.dump:yuv2rgb.mod.baseline.scalar.dump.ref
###END:
