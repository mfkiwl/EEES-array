...
###TOOL: ${S_CG}
###ARGS: ${FILEDIR}/transpose_inv.sir ${SOLVER_ROOT}/usr/lib/libsolver.sir -arch-cfg ${SOLVER_ROOT}/arch/baseline-32b-4stage-bypass.json -o transpose-4-b.s
###TOOL: ${S_AS}
...
###TOOL: ${S_CG}
###ARGS: ${FILEDIR}/transpose_inv.sir ${SOLVER_ROOT}/usr/lib/libsolver.sir -arch-cfg ${SOLVER_ROOT}/arch/baseline-32b-4stage.json -o transpose-4.s
###TOOL: ${S_AS}
...
###TOOL: ${S_CG}
###ARGS: ${FILEDIR}/transpose_inv.sir ${SOLVER_ROOT}/usr/lib/libsolver.sir -arch-cfg ${SOLVER_ROOT}/arch/baseline-32b-5stage-bypass.json -o transpose-5-b.s
###TOOL: ${S_AS}
...
###TOOL: ${S_CG}
###ARGS: ${FILEDIR}/transpose_inv.sir ${SOLVER_ROOT}/usr/lib/libsolver.sir -arch-cfg ${SOLVER_ROOT}/arch/baseline-32b-5stage.json -o transpose-5.s
###TOOL: ${S_AS}
...
###TOOL: ${S_CC}
###ARGS: ${FILEDIR}/transpose_inv.sir -lsolver --arch-cfg ${SOLVER_ROOT}/arch/baseline-32b-4stage.json -o transpose-4
...
###TOOL: ${S_CC}
###ARGS: ${FILEDIR}/transpose_inv.sir -lsolver --arch-cfg ${SOLVER_ROOT}/arch/baseline-32b-4stage-bypass.json -o transpose-4-b
