...
####BEGIN: vector 3-tap convolution OpenCL kernel app 4 stage RTL
####TOOL: ${S_CC}
####ARGS: ${FILE} -X sir -o cl_conv3-4 --arch-cfg ${SOLVER_ROOT}/arch/baseline-32b-4stage.json --arch-param pe:16
####RTL: cl_conv3-4.zip ${SOLVER_ROOT}/arch/baseline-32b-4stage.json ${SOLVER_ROOT}/rtl
####MSTRICT:
