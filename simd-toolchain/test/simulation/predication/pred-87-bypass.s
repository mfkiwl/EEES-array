...
###TOOL: ${S_AS}
###ARGS: ${FILE} -o pred-87-4-b -arch-param stage:4,predicate:2
###TOOL: ${S_SIM}
###ARGS: -imem 0:uni:pred-87-4-b -arch-param stage:4,predicate:2 -dump-dmem -dump-dmem-prefix pred-87-4-b
###MDUMP: pred-87-4-b.baseline.vector.dump:pred-87.baseline.vector.dump.ref
###END:

###BEGIN: pred for #87 test 4 stage RTL
###TOOL: ${S_CC}
###ARGS: ${FILE} -o pred-87-4-b --arch-cfg ${SOLVER_ROOT}/arch/baseline-32b-4stage-bypass.json
###RTL: pred-87-4-b.zip ${SOLVER_ROOT}/arch/baseline-32b-4stage-bypass.json ${SOLVER_ROOT}/rtl
