...
void 
des(unsigned int * ciphertext, unsigned int * plaintext, unsigned int ks[16][2],
    unsigned int Spbox[8][64], int n) {
  int i;
...
int out[128*2*sizeof(int)];
int in[128*2*sizeof(int)];
int k[16][2] = {
};
