...
# dont store them intermediately in DMEM.
...
jal $COL_PROJ       || v.add r19, r0, {{ columnThreshold  }}
nop
...
#init
mul r1, r3, r4                || v.add r9, r0, 0
add r0, r1, 0                 || v.add r2, CP, 0
...
$SIGMA_LOOP:
add r0, r13, 0               || v.srl r19, CP, 2
nop                          || v.add r18, r19, r1
$SIGMA_1:
lw   r1, r7, 0
add  r0, r1, 0               || v.add r4, l.r4, 0
lw   r1, r6, 0
add  r0, r1, 0               || v.add r5, l.r5, 0
add  r6, r6, -4
sfeq r7, r13
bnf  $SIGMA_1
add  r7, r7, -4

#calc sigmas of these values:
nop                          || v.sll r16, r5,  11

jal $DIV                     || v.add r15, r4,  0  #DIV!! r11 = r16/r15
nop                          || v.nop
sll r1, r4, 2                || v.mul r19, r11, r2
add r13, r13, r1             || v.sra r19, r19, 11
sll r1, r4, 3                || v.sub r19, r3,  r19
add r7, r7, r1               || v.srl r6,  r19, 6

add r6, r6, r1               || v.sub r19, r3,  r5
jal $DIV                     || v.sll r16, r19, 11   #DIV!! r11 = r16/r15
nop                          || v.sub r15, r2, r4
nop                          || v.mul r19, r11, r4
sfgtu r7, r8                 || v.sra r19, r19, 11
cmov r7, r8, r7              || v.sub r19, r19, r5
nop                          || v.srl r19, r19, 6

nop                          || v.mul r8 , r6,  r19

#                            check if division was nonsense and Sigma needs to be zero
zimm 5                       || v.sub   r19, r2,  r4
add r1, r0, 0                || v.sfeq  r19, r0
add r1, r1, -4               || v.cmov  r8,  r0,  r8
cmov r6, r1, r6              || v.sfeq  r4,  r0
zimm 4                       || v.cmov  r8,  r0,  r8
sfgeu r13, 0                 || v.sfgtu r8,  r9
bnf $SIGMA_LOOP              || v.cmov  r9,  r8,  r9 #max sigma selection
nop                          || v.cmov  r17, r18, r17

#collect max into CP to find out the threshold:
nop                          || v.sfgtu r.r9, r9        #first do cheap reduce with neighbor
nop                          || v.cmov r9, r.r9, r9
nop                          || v.cmov r17, r.r17, r17

#set communication-wrap-mode back to normal (read from CP)
sw r0, r0, -1
srl r1, r4,  1               || v.add r2,  r.r9,  0
add r6, r1, -1               || v.add r3,  r.r17, 0
nop                          || v.sfeq P1, r1, r0
...
add r6, r6, -1               || v.add r19, r.r2, 0
sfeq r6, r0                  || v.add r2, r.r19, 0
bnf $SIGMA_MAX               || v.add r19, r.r3, 0
nop                          || v.add r3, r.r19, 0

#add r7, h.r0, 0              || v.add.P1 --, r9, 0 #value of max sigma!
jr r12                       || v.nop
add r6, h.r0, 0              || v.add.P1 r0, r17, 0 #index of max sigma == TH
#
...
$DIV_CALC_MSB:
sfeq r10, 31            || v.srl       r20, r15, r10
bnf $DIV_CALC_MSB       || v.sfne      r0, r20
add r10, r10, 1         || v.cmov      r10, CP, r10
#convert to number of leading zeroes -1
nop                     || v.add       r20,  r0, 31
nop                     || v.sub       r10, r20, r10
...
$DIV_MAIN:
nop                     || v.sfleu     P1,  r8, r10  #set flag if we want to engage in this particular round
nop                     || v.sll.P1    r20,  r15, r8
nop                     || v.sub.P1    r13, r12, r20
nop                     || v.sfges.P1  P2,  r13, r0
nop                     || v.add.P1.P2 r12, r13, 0
sfeq r10, r0            || v.sll.P1.P2 r20,  r14, r8
bnf $DIV_MAIN           || v.or.P1.P2  r11, r11, r20
...
zimm 0
add     r7,     r0,     128     || v.add     r8, r5, 0
add     r6,     r0,     0
$HIST_1:
sfeq    r6,     r7              || v.sw      r8,   r0,      0          #first ALU is comming from the function call!
bnf     $HIST_1                 || v.sw      r8,   r0,      1
add     r6,     r6,     1       || v.add     r8,   r8,      8
#histogram calculation
add r6, r2, 0    #start address
sll r1, r3, 2
add r7, r6, r1 #end address

$HIST_2:
add r6, r6 , 4                  || v.lw      r8,     CP,    0          # load pixel
nop                             || v.sll     r8,     r8,    2          # pixel*4
nop                             || v.add     r7,     r5,    r8        # calc bin address
sfeq r7, r6                     || v.lw      r8,     r7,    0          # load bin
bnf $HIST_2                     || v.add     r8,     r8,    1          # increase bin
nop                             || v.sw      r7,     r8,    0          # store bin
...
# r9    = return address
$HIST_REDUCE:
add    r6, r3, -1                           || v.sll    r9, r6, 2
sfltu  P1, r4, r3                           || v.add    r6, r9, r2
...
$HIST_R4_PHASE1:
sfeq r7, r6                                 || v.lw.P1   r9,  r2,   0
nop                                         || v.add.P1  r2,  r2,   4
bnf $HIST_R4_PHASE1                         || v.add.P1  r5,  l.r5, r9
...
nop                                         || v.lw.P1    r9,  r2,   0
sfeq r7, r6                                 || v.add.P1   r5,  l.r5, r9
...
sll r1, r3, 2
add r11, r1, r5
add r10, r11, -4                            || v.add  r7, r0, 0
add r6, r0, 0                               || v.zimm {{ imm1(cfg.pe.size-1) }}
add r7, r0, 0                               || v.add r9, r0, {{ imm2(cfg.pe.size-1) }}
add r8, r5, 0                               || v.sfeq P2, r1, r9

###N.B. MODIFIED FOR HISTOGRAMMING!!!
$HIST_R4_PHASE2:
sfeq r8, r10                                || v.lw.P1 r9, r2, 0
add r11, r11, 4                             || v.mul.P2 r8, r7, r5      #old_r5*i
add r6, t.r0, r6                            || v.add.P1 r5, l.r5, r9    #r5= l.r5+LSU || old_r5 to CP
sw  r8, r6,  0                              || v.nop
add r7, t.r0, r7                            || v.add.P2 r0, r8, 0       #old_r5*i to CP
sw  r11, r7, -1                             || v.add.P1 r2, r2, 4
bnf $HIST_R4_PHASE2                         || v.sfltu.P1 P1, r2, r6
...
#(v.)r6 = Threshold
$BINAROSION:
add r0, r6, 0                   || v.add  r6,   CP, 0
nop                             || v.lw    r19,  CP, 0
nop                             || v.sfltu r19, r6
nop                             || v.cmov  r2,  r0, 1
add r1, r3, -1                  || v.lw    r19,  CP, 0
sll r6, r1, 2                   || v.sfltu r19, r6
add r1, r0,  4                  || v.cmov  r3,  r0, 1
add r1, r1, 4                   || v.add   r5,  r0, 0

$BINA_LOOP:
add r1, r1, 4                   || v.lw  r19,  CP,   0
nop                             || v.and r20, r3,   r2
nop                             || v.and r20, r.r3, r20
nop                             || v.and r20, l.r3, r20
nop                             || v.sfltu r19, r6
nop                             || v.cmov  r4,  r0, 1
nop                             || v.and r19, r4,  r20
nop                             || v.add r5, r5,   r19
add r0, r1, 0                   || v.sw  CP, r19,  -2

add r1, r1, 4                   || v.lw  r19,  CP,   0
nop                             || v.and r20, r4,   r3
nop                             || v.and r20, r.r4, r20
nop                             || v.and r20, l.r4, r20
nop                             || v.sfltu r19, r6
nop                             || v.cmov  r2,  r0, 1
nop                             || v.and r19, r2,  r20
nop                             || v.add r5, r5,   r19
add r0, r1, 0                   || v.sw  CP, r19,  -2

add r1, r1, 4                   || v.lw r19,  CP,   0
nop                             || v.and r20, r2,   r4
nop                             || v.and r20, r.r2, r20
nop                             || v.and r20, l.r2, r20
nop                             || v.sfltu r19, r6
nop                             || v.cmov  r3,  r0, 1
sfleu r1, r6                    || v.and r19, r3,  r20
bf  $BINA_LOOP                  || v.add r5, r5,   r19
add r0, r1, 0                   || v.sw  CP, r19,  -2

#blank bottom line:
add r0, r6, 0                   || v.sw  CP, r0,  0
#blank top line and store column projection in r2
jr r9                           || v.add  r2, r5, 0
nop                             || v.sw   r0, r0,  0
#
...
#
$COL_PROJ:
add r8, r0, 0                               || v.sfleu r2, r19          #compare to threshold
add r6, r0, 3                               || v.cmov r19, r0, 1         #store thresholded result in ALU
add r5, r0, 0
add r1, r0, 0
$col_proj_comm:
sfeq r0, r8
bf $xstart_is_zero
    add r10, h.r0 ,0                        || v.add r19, r.r19, 0       #communicate thresholded value through neighbors to cp
    sfne r10, r0
    ...
    add r8, r0, 0                                                 #start=0
    bf  $col_proj_comm_loop_end
    add r10, r1, r7                                                #x_start+x_end
    srl r10, r10, 1                                                #(x_start+x_end/2)
    sw r5, r10, 0                                                  #store center
...
add r0, r3, 0                           || v.add r6, CP, 0
nop                                     || v.add r5, r0, 0
add r6, r3, -1                          || v.sll r19, r6, 2
sfltu P1, r4, r3                        || v.add r6, r19, r2
add.P1 r6, r4, 0
add r7, r0, 1                           || v.sfgeu  P1, r0, r1
#phase1: lead in
#for min(nPE, nVect) = r6
$RP_PHASE1:
sfeq r7, r6                             || v.lw.P1   r19,  r2,   0
nop                                     || v.add.P1  r2,  r2,   4
bnf $RP_PHASE1                          || v.add.P1  r5,  l.r5, r19
add r7, r7, 1                           || v.sfgeu   P1,  CP,   r1
...
nop                                       || v.lw.P1.P2     r19,  r2,   0
nop                                       || v.add.P1.P2    r5,  l.r5, r19
sfeq r7, r6                               || v.add.P1.P2    r2,  r2,   4
bnf  $RP_PHASE1_B                         || v.sfltu.P1.P2  P2,  r2,  r6
add  r7, r7, 1                            || v.sfgeu.P2     P1,  CP,   r1
##Faster, but accesses memory out of bounds (always reads array of nPE vectors (altough not modified)
#nop                                      || v.lw.P1   --,  r2,   0
...
add r6, r0,  2                            || v.lw.P1     r19,  r2,   0     #prefetch first element
add r1, r0,  0                            || v.add.P1    r5,  l.r5, r19
add r10, r0, 1                            || v.add.P1    r2, r2, 4
nop                                       || v.sfltu.P1  P1, r2, r6
$row_proj_comm:
sfeq r0, r8                               || v.sfltu.P2  r5, r7           #compare to threshold in r7
bf $ystart_is_zero                        || v.cmov.P2   r19, r0,  1
    sfne t.r0, r0                         || v.add.P2    r0, r19, 0       #communicate thesholded value to CP
    #start!=0 and pixel!=0 : continue
    bf $row_proj_comm_loop_end            || v.lw.P1     r19,  r2,   0
    #start!=0 and pixel==0 : end
    sub  r19, r1, r7
    sfleu r19, r6
    #if length < TH: start=0
    ...
    add r19, r1, r7                                                      #y_start+y_end
    srl r19, r19, 1                                                      #(y_start+y_end/2)
    sw  r5, r19, 0                                                      #store center
    j   $row_proj_comm_loop_end
    add r5, r5, 4                                                       #increment storage pointer
$ystart_is_zero:
    #(thanks to branch slot flag is set)
    #if start==0 and pixel==0 : start=0
        cmov r8, r10, r0                || v.lw.P1     r19,  r2,   0
        cmov r7, r1, r7
    #if start==0 and pixel!=0 : start=1, start_y=r1(index)
$row_proj_comm_loop_end:
sfltu r1, r3                            || v.add.P1    r5, l.r5, r19
bf  $row_proj_comm                      || v.add.P1    r2, r2,   4
add r1, r1, 1                           || v.sfltu.P1  P1, r2,  r6
sfeq r0, r8
