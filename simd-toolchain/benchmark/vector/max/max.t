...
nop                                     || v.sfgts.P1 l.r5, LSU
bnf $R4_PHASE1                          || v.cmov.P1 r5,  l.r5, LSU
...
nop                                       || v.lw.P1.P2     --,  r2,   0
nop                                       || v.sfgts.P1.P2  l.r5, LSU
nop                                       || v.cmov.P1.P2    r5,  l.r5, LSU
sfeq ALU, r6                              || v.add.P1.P2    r2,  r2,   4
bnf  $R4_PHASE1_B                         || v.sfltu.P1.P2  P2,  ALU,  r6
...
$R4_PHASE2_INIT:
sll --, r3, 2
add r6, MUL, r5 #real stop address
add r10, ALU, -4 #address to compare to in PHASE2 loop
...
sfeq MUL, r0
bf $R4_PHASE2
add r7, r0, 0                           || v.add    --, r5, 0


$R4_PHASE2_UNROLLED:
sfeq ALU, r8                            || v.lw.P1  --, r2, 0
nop                                     || v.sfgts  l.ALU, LSU
add --, t.r0, 0                         || v.cmov.P1 r5, l.r5, LSU
sw  r7, ALU,  0                         || v.lw.P1  --, r2, 1
nop                                     || v.sfgts  l.ALU, LSU
add --, t.r0, 0                         || v.cmov.P1 r5, l.r5, LSU
sw  r7, ALU,  1                         || v.lw.P1  --, r2, 2
nop                                     || v.sfgts  l.ALU, LSU
add --, t.r0, 0                         || v.cmov.P1 r5, l.r5, LSU
sw  r7, ALU,  2                         || v.lw.P1  --, r2, 3
nop                                     || v.sfgts  l.ALU, LSU
add --, t.r0, 0                         || v.cmov.P1 r5, l.r5, LSU
sw  r7, ALU,  3                         || v.lw.P1  --, r2, 4
nop                                     || v.sfgts  l.ALU, LSU
add --, t.r0, 0                         || v.cmov.P1 r5, l.r5, LSU
sw  r7, ALU,  4                         || v.lw.P1  --, r2, 5
nop                                     || v.sfgts  l.ALU, LSU
add --, t.r0, 0                         || v.cmov.P1 r5, l.r5, LSU
sw  r7, ALU,  5                         || v.lw.P1  --, r2, 6
nop                                     || v.sfgts  l.ALU, LSU
add --, t.r0, 0                         || v.cmov.P1 r5, l.r5, LSU
sw  r7, ALU,  6                         || v.lw.P1  --, r2, 7
nop                                     || v.sfgts  l.ALU, LSU
add --, t.r0, 0                         || v.cmov.P1 r5, l.r5, LSU
sw  r7, ALU,  7
bnf $R4_PHASE2_UNROLLED                 || v.add.P1 r2, r2, 32
add r7, r7, 32                          || v.sfltu.P1 P1, ALU, r6
...
nop                                     || v.sfgts.P1 l.r5, LSU
add --, t.r0, 0                         || v.cmov.P1 r5, l.r5, LSU
sw  r7, ALU, 0                          || v.add.P1 r2, r2, 4
bnf $R4_PHASE2                          || v.sfltu.P1 P1, ALU, r6
add r7, r7, 4
