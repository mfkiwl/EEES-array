...
$TRANSPOSE_1:
add r3, r2, 0                       || v.add r7, r2, r9
sflts r3, 3                         || v.sll r7, r7, 2        #load_addr*4
bf $TRANSPOSE_3                     || v.lw  r7, r7, 1        #load element dmem[addr+1] into r4
nop                                 || v.add r6, r3, -1         #increase store address by 1 in tmp r6
...
#loop to do any remaining shifts
$TRANSPOSE_3:
sfeq r3, 0                          || v.sll r8, r3, 2       #store address*4
bf $TRANSPOSE_2                     || v.sw  r8, r7, 0     #store received element at  store_addr+ offset off num_pe+1                    !!!!!
sfeq r3, 1                          || v.add r7, l.r7, 0
bf $TRANSPOSE_2                     || v.sw  r8, r7, 0     #store received element at  store_addr+ offset off num_pe+1                    !!!!!
nop                                 || v.add r7, l.r7, 0
nop                                 || v.sw  r8, r7, 0     #store received element at  store_addr+ offset off num_pe+1
...
$TRANSPOSE_2:
sfeq r2, r4                         || v.and r3, r6, r9      #wrap around store address with bitmask
bnf $TRANSPOSE_1                    || v.add r2, r2, 1        #increase load_addres by 1
add r2, r2, 1                       || v.and r2, r2, r9      # load_Address wrap around by bitmask
...
$TRANSPOSE_5:
add r3, r2, -2                      || v.add r7, r2, r9
sflts r3, 3                         || v.sll r7, r7, 2        #load_addr*4
bf $TRANSPOSE_7                     || v.lw  r7, r7, 1         # load elements
nop                                 || v.add r6, r3, -1        #increase store address by 1 in tmp r6
...
$TRANSPOSE_7:
sfeq r3, 0                          || v.sll r8, r3, 2       #store address*4
bf $TRANSPOSE_6                     || v.sw  r8, r7, 0     #store received element at  store_addr+ offset off num_pe+1                    !!!!!
sfeq r3, 1                          || v.add r7, r.r7, 0
bf $TRANSPOSE_6                     || v.sw  r8, r7, 0     #store received element at  store_addr+ offset off num_pe+1                    !!!!!
nop                                 || v.add r7, r.r7, 0
nop                                 || v.sw  r8, r7, 0     #store received element at  store_addr+ offset off num_pe+1
